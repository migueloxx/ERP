...
<head>
    ...
    <title>ERP 2DAM - Borrar Producto</title>
...
<?php
       ...
       echo"<form method=\"post\" action=\"blank1.php\">";
        ...
        function todos_datos(){
            ...
            echo "<div class=\"row\">";
                echo "<div class=\"col-lg-12\">";
                    echo "<h1 class=\"page-header\">Borrar Productos</h1>";
                echo "</div>";
                echo "<!-- /.col-lg-12 -->";
            echo "</div>";
            echo "<!-- /.row -->";
            echo "<div class=\"row\">";
                echo "<div class=\"col-lg-12\">";
                    ...
                    echo "</tbody>";
					 echo "</table>";
                            echo "</div>";   
                                echo "<button type=\"submit\" value=\"Borrar Producto\" name=\"borrar\" class=\"btn btn-default\">Delete Product</button>";
...
//BORRADO DE PRODUCTOS DE LA BASE DE DATOS.
          ...
          if(isset ($_POST['borrar'])){
              ...
              for ($i=0; $i<$tamaño; $i++) {  
                  $del_id = $array[$i];
                  $sql = "DELETE FROM Productos WHERE Id_Producto='$del_id'"; }
                        $result=mysqli_query(conectar_bbdd(),$sql); 
              }
              todos_datos();
          }
