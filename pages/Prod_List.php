...
<head>
    ...
    <title>ERP 2DAM - Listar Productos</title>
            ...
            <div class="row">
				...
				<?php
					...
					function insert_productos(){
                            ...
                            // creamos el INSERT sobre la tabla productos
                            $query = 'INSERT INTO productos VALUES ('. $_POST['id'].',"'. $_POST['denominacion'].'", '. $_POST['precio'].', 
							'. $_POST['coste'] .',"'. $_POST['ubicacion'] .'","'. $_POST['proveedor'] .'",'. $_POST['stock'] .',"'. $_POST['imagen'] .'")';						
                            // Realizamos la query
