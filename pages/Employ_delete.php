...
<head>
    ...
    <title>ERP 2DAM - Borrar Empleado</title>
...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Borrado de empleado</h1>
                    </div>
                    <!-- /.col-lg-12 -->
					...
					$ssql = "DELETE FROM empleados WHERE dni = '".$dnie."'";
					...
					echo "El DNI introducido no es correcto o el empleado no existe";
					}
